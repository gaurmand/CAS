...
//=============================================================================
TEST(subtractTest, SubtractZeroTerm) 
{  
   EXPECT_EQ(
...
//=============================================================================
TEST(subtractTest, SubtractTerm) 
{  
   // Append case
   EXPECT_EQ(
   ...
   // Sum case
   EXPECT_EQ(
      Polynomial<Rational>({Term(Rational(1,2),0), Term(Rational(2,3),1), Term(Rational(1,4),2)}) - Term(Rational(1,3),1), 
...
//=============================================================================
TEST(subtractTest, SubtractZeroPolynomial) 
{  
   EXPECT_EQ(
   ...
   EXPECT_EQ(
      ...
      Polynomial<Rational>({-Term(Rational(1),0)}));
}

//=============================================================================
TEST(subtractTest, SubtractPolynomial) 
{  
   EXPECT_EQ(
   ...
   EXPECT_EQ(
      Polynomial<Rational>({Term(Rational(2,2),0), Term(Rational(2,3),1), Term(Rational(3,4),2)}) - 
      Polynomial<Rational>({Term(Rational(1,2),0), Term(Rational(1,3),1), Term(Rational(1,4),2)}), 
      Polynomial<Rational>({Term(Rational(1,2),0), Term(Rational(1,3),1), Term(Rational(1,2),2)}));
